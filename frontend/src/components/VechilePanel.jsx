    ...
    <div>
      <h5 className='text-center p-3 absolute top-0 w-[90%] '><i
        ...
        onClick={()=>{
          ...
          <h2 className='texet-2xl font-bold pr-[10px]'>₹{Math.round(props.fare.car / 10)}</h2>
        </div>
        <div onClick={()=>{
            props.setconfirmRidePanel(true)
            props.setVechileType('car')
         ...
         className="w-full border-2 border-gray-300 active:border-black  rounded-lg  flex items-center justify-between mb-2">
          ...
          <h2 className='texet-2xl font-bold pr-[10px]'>₹{Math.round(props.fare.motorcycle / 10)}</h2>
        </div>
        <div onClick={()=>{
            props.setconfirmRidePanel(true)
          ...
          <h2 className='texet-2xl font-bold pr-[10px]'>₹{Math.round(props.fare.auto / 10)}</h2>
        </div>
        <div onClick={()=>{
            props.setconfirmRidePanel(true)
         ...
         className="w-full  border-2 border-gray-300 active:border-black rounded-lg  flex items-center justify-between mb-2">
          ...
          <h2 className='texet-2xl font-bold pr-[10px]'>₹{Math.round(props.fare.auto / 20)}</h2>
        </div>
    </div>
  )
}
